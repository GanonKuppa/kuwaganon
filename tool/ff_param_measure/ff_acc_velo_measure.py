...
def on_message(client, userdata, msg):    
    if msg.topic == "mouse":
        ...
        if (not (-0.01 < V_L < 0.01)) and (not (-0.01 < V_R < 0.01) ) and not (-0.01 < target_a < 0.01) and (target_v > 0.05):
            ...
            measure_list.append([V_L, V_R,V_acc_velo , (V_L - V_R)/2, v, a, target_v, target_a])
