...
void SE_I7(void);
void SE_Im7(void);
void SE_CursorMove(void);

void SE_CURSOR_MOVE(int8_t offset = 0);
void SE_ON_ACTIVITY();
void SE_END_ACTIVITY();
void SE_CONFIRM(int8_t offset = 0);
void SE_POSITION_CHANGE();
void SE_CONTACT_WALL();
void SE_CORNER_R();
void SE_CORNER_L();
