...
void INT_Excep_CMT0_CMI0(void){timeInterrupt(); }



//;0x0074  CMI1
extern void timeInterrupt_sub();
void INT_Excep_CMT1_CMI1(void){timeInterrupt_sub();}
...
//;0x019C TXIF9
extern  void interruptFIFOEmpty(void);

//#pragma interrupt (INT_Excep_SCIFA9_TXIF9 (enable,vect=0x019C))
