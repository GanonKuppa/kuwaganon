...
float turn_s2d45_v_35_d_pre_offset; //340
float turn_s2d45_v_40_d_pre_offset; //341
float turn_s2d45_v_45_d_pre_offset; //342
float turn_s2d45_v_50_d_pre_offset; //343
float turn_s2d45_v_55_d_pre_offset; //344
float turn_s2d45_v_60_d_pre_offset; //345
float turn_s2d45_v_65_d_pre_offset; //346
float turn_s2d45_v_70_d_pre_offset; //347
float turn_s2d45_v_75_d_pre_offset; //348
float turn_s2d45_v_80_d_pre_offset; //349
float turn_s2d135_v_35_d_pre_offset; //350
float turn_s2d135_v_40_d_pre_offset; //351
float turn_s2d135_v_45_d_pre_offset; //352
float turn_s2d135_v_50_d_pre_offset; //353
float turn_s2d135_v_55_d_pre_offset; //354
float turn_s2d135_v_60_d_pre_offset; //355
float turn_s2d135_v_65_d_pre_offset; //356
float turn_s2d135_v_70_d_pre_offset; //357
float turn_s2d135_v_75_d_pre_offset; //358
float turn_s2d135_v_80_d_pre_offset; //359
float turn_d2s45_v_35_d_pre_offset; //360
float turn_d2s45_v_40_d_pre_offset; //361
float turn_d2s45_v_45_d_pre_offset; //362
float turn_d2s45_v_50_d_pre_offset; //363
float turn_d2s45_v_55_d_pre_offset; //364
float turn_d2s45_v_60_d_pre_offset; //365
float turn_d2s45_v_65_d_pre_offset; //366
float turn_d2s45_v_70_d_pre_offset; //367
float turn_d2s45_v_75_d_pre_offset; //368
float turn_d2s45_v_80_d_pre_offset; //369
float turn_d2s135_v_35_d_pre_offset; //370
float turn_d2s135_v_40_d_pre_offset; //371
float turn_d2s135_v_45_d_pre_offset; //372
float turn_d2s135_v_50_d_pre_offset; //373
float turn_d2s135_v_55_d_pre_offset; //374
float turn_d2s135_v_60_d_pre_offset; //375
float turn_d2s135_v_65_d_pre_offset; //376
float turn_d2s135_v_70_d_pre_offset; //377
float turn_d2s135_v_75_d_pre_offset; //378
float turn_d2s135_v_80_d_pre_offset; //379
 ; //380
 ; //381
 ; //382
 ; //383
